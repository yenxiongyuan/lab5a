...
the second element is the product of those three numbers,  and the third and 
fourth elements are strings that EXACTLY follow this example and use the values that were input into the function:
...
first element is the sum of the numbers in the array, and 
...
function sumArray(sumArr) { //eslint-disable-line
  let numOne= testArray[0];
  let numTwo= testArray[1];
  let numThree= testArray[2];
  // console.log(sum(numOne + numTwo, numThree), `${testArray} was passed in as an array numbers, and ${numOne + numTwo + numThree} is their sum.`);

  return [sum(numOne + numTwo,  numThree)[0], `${testArray} was passed in as an array of numbers, and ${numOne + numTwo + numThree} is their sum.`];
